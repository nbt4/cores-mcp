...
func main() {
	...
	mux.HandleFunc("GET /mcp/docs", func(w http.ResponseWriter, _ *http.Request) {
		httpx.JSON(w, http.StatusOK, map[string]any{
			...
			"transport": "Streamable HTTP", "access": map[bool]string{true: "read and confirmed guided writes across all Cores", false: "read-only"}[cfg.EnableWrites], "scopes": supportedScopes(cfg),
